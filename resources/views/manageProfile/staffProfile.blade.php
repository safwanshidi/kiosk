            ...
            <div class="col-8">
                <div>
                    <div class="row mt-1" style="background-color: #1a2f77;">
                        <h5 class="text-light mt-2">{{ ucwords(strtolower(auth()->user()->role)) }}</h5>
                    </div>
                    <div class="row p-3" style="background-color: #d9d9d9">
                        @if (auth()->user()->role == 'ADMIN')
                            <h4 class="mb-4 text-center"><strong>PROFILE</strong></h4>
                        @else
                            <div class="row">
                                <div class="col text-center">
                                    <h6>STAFF ID</h6>
                                    <h5><strong>{{ auth()->user()->id }}</strong></h5>
                                </div>
                                <div class="col">
                        ...
                        <form method="POST" action="{{ route('user.updateUserProfile', $user->id) }}">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append" style="line-height: 0;">
                                            <button class="btn bg-light btn-outline-secondary text-danger" type="reset">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append" style="line-height: 0;">
                                            <button class="btn bg-light btn-outline-secondary text-danger" type="button">
                                                <i class="fa-solid fa-xmark"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text mt-1" id="password-toggle"
                            ...
                            <div class="form-group row mb-4">
                                <label for="newPassword" class="col-md-4 col-form-label text-md-right" style="font-weight: bold;">
                                    {{ __('NEW PASSWORD:') }}
                                </label>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span  class="input-group-text text-center mt-1" id="password-new-toggle" onclick="togglePasswordNewVisibility()">
